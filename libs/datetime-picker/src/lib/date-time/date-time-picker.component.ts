...
export class OwlDateTimeComponent<T> extends OwlDateTime<T>
    ...
    private dateChangeStreamSub = Subscription.EMPTY;
    ...
    public open(): void {
        ...
        this.dateChangeStreamSub = this.pickerContainer.dateChangeStream.subscribe(
            (event: any) => {
    ...
    public close(): void {
        ...
        if (this.dateChangeStreamSub) {
            this.dateChangeStreamSub.unsubscribe();
            this.dateChangeStreamSub = null;
        }
