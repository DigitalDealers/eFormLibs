...
export const g_EARTH_MERI_CIRCUMFERENCE = 40007860;

// Length of a degree latitude at the equator
export const g_METERS_PER_DEGREE_LATITUDE = 110574;

// Number of bits per geohash character
export const g_BITS_PER_CHAR = 5;

// Maximum length of a geohash in bits
export const g_MAXIMUM_BITS_PRECISION: number = 22 * g_BITS_PER_CHAR;

// Equatorial radius of the earth in meters
export const g_EARTH_EQ_RADIUS = 6378137.0;
...
export const g_E2 = 0.00669447819799;
