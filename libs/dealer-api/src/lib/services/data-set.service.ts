...
export class DataSetService {
  ...
  public create(body): Observable<any> {
    return this._http
      .post(this._url, body)
      .pipe(map(DataSetMapper.prepareData));
  }
  ...
  public getList(params = new HttpParams()): Observable<any> {
    return this._http
      ...
      .pipe(map(DataSetMapper.prepareListData));
  }

  public getDataSetHistory(id, params = new HttpParams()): Observable<any> {
    return this._http
      .get(`${this._url}/${id}/history`, { params })
      .pipe(map(DataSetMapper.prepareData));
  }
  ...
  public updateAlert(alertId, data): Observable<any> {
    return this._http.put(
      `${this._url}/${data.dataSetId}/alerts/${alertId}`,
      data
    );
  }

  public addAlert(alertId, data): Observable<any> {
  ...
  public createCustomerSync(dataSetId, body): Observable<any> {
    return this._http.post(
      `${this._url}/${dataSetId}/hooks/customerSync`,
      body
    );
  }
